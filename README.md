...
* **$-0.05$**: Зміщення, що враховує біомеханічну реальність: пішоходи досягають максимальної швидкості при невеликому спуску приблизно на 5%.
...
Запустіть головний скрипт для обчислення маршруту та генерації графа:
...
Після успішного запуску скрипт генерує наступний файл візуалізації у кореневій директорії:
